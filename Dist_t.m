...
%%%%%%%%%%%%%%%%%%%%%%%%%
semilogy(Ndis, misdetection(1, :), 'r--^','LineWidth',1,'MarkerSize',10)
hold on
semilogy(Ndis, misdetection(2, :), 'r--v','LineWidth',1,'MarkerSize',10)
semilogy(Ndis, misdetection(3, :), 'g--*','LineWidth',1,'MarkerSize',10)
semilogy(Ndis, misdetection(5, :), 'b--x','LineWidth',1,'MarkerSize',10)
semilogy(Ndis, misdetection(4, :), 'k-o','LineWidth',1,'MarkerSize',10)
semilogy(Ndis, misdetbound, 'k-s','LineWidth',1,'MarkerSize',10)
